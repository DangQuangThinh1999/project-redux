  ...
  return (
    <div>
      <div className="bg-gray-100 ">
        <div className=" rounded relative h-screen flex flex-col justify-center">
          ...
          <p className="absolute mx-auto inset-x-0 my-auto inset-y-[65%] text-base font-medium text-gray-800 text-center">
            Loading ...
          </p>
        </div>
      </div>
